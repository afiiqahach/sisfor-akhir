<template>
    <main class="overflow-x-hidden">
        ...
        <section class="pt-24">
            <div class="h-[202px] relative">
                ...
                <div class="w-[474px] h-[45px] relative top-20 left-20">
                    <a href="#" class="w-[302px] h-[45px] left-[172px] absolute text-slate-300 text-2xl font-medium">Manajemen</a>
        ...
        <section class="pt-8">
            <div class="ml-28 text-black text-3xl font-bold">PIMPINAN FAKULTAS
